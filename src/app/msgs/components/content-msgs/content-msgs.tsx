...
} from '../../query-api/get-messages-history';
...
export const ContentMsgs = () => {
  ...
  const normalizedDataGetMessagesHistory =
    isErrorGetMessagesHistory || !dataGetMessagesHistory?.data
      ? []
  ...
  return (
    <div className="flex flex-col gap-4 w-full shadow-lg p-2 rounded-b-md">
      <HeaderUsers
        users={[...allUsers]}
