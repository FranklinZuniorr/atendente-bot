...
"[project]/.next-internal/server/app/api/client/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/client/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Não foi possível obter os dados do telefone!'
        }, {
            status: 404
        });
    }
    ...
    const execute = async ()=>{
        try {
            ...
            try {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$services$2f$evolution$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EvolutionService"].logoutInstance(telephone);
                await new Promise((resolve)=>setTimeout(()=>{
                        resolve(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$services$2f$evolution$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EvolutionService"].deleteInstance(telephone));
                    }, 3000));
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'Não foi possível finalizar a conexão!'
                }, {
                    status: 400
                });
            }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f8baea6e._.js.map