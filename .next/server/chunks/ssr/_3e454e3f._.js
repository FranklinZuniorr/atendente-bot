...
"[project]/src/app/comprar-tokens/query-api/get-checkout-url.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getCheckoutUrl = async (params)=>{
    ...
    try {
        const response = (await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$configs$2f$axios$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HttpClientApi"].post(path, params)).data;
        return response;
    } catch  {
        throw new Error(path);
    }
};
const useGetCheckoutUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$helpers$2f$react$2d$query$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateReactQuery"])(KEY_GET_CHECKOUT_URL, getCheckoutUrl);
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$comprar$2d$tokens$2f$query$2d$api$2f$get$2d$checkout$2d$url$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/comprar-tokens/query-api/get-checkout-url.ts [app-ssr] (ecmascript)");
...
const CardDefaultTokens = ()=>{
    ...
    const { data: dataCheckoutUrl, isFetching: isFetchingCheckoutUrl } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$comprar$2d$tokens$2f$query$2d$api$2f$get$2d$checkout$2d$url$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGetCheckoutUrl"])({
        clientId: client.id
    }, {
...
//# sourceMappingURL=_3e454e3f._.js.map