...
"[project]/.next-internal/server/app/api/info/all-by-client/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/info/all-by-client/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    const execute = async ()=>{
        try {
            ...
            if (!clientId) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'O id do cliente é orbigatório!'
                }, {
                    status: 400
                });
            }
            const clients = await infoRepository.getAllByClientId(clientId);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                data: clients
            }, {
                status: 200
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8be843c8._.js.map